...
| **Parameter** | **Type** | **Value** | **Description**                                                                                                                                                                                                                                                                                                                                     |
|---------------|----------|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| _id           | String   |           | the image`_id` you had generated, you can got it from https://openapi.akool.com/api/open/v3/content/image/createbyprompt                                                                                                                                                                                                                              |
...
| **Parameter**  | **Type** | **Value** | **Description**                                                                                                                                                                                           |
|----------------|----------|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| image_model_id | String   |           | image db id：You can get it based on the `_id` field returned by [https://openapi.akool.com/api/open/v3/content/image/createbyprompt](https://openapi.akool.com/api/open/v3/content/image/createbybutton) api. |
