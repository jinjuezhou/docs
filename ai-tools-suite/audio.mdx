...
| **Parameter**  | **Type** | **Value** | **Description**                                                                                                                   |
|----------------|----------|-----------|-----------------------------------------------------------------------------------------------------------------------------------|
| audio_model_id | String   |           | audio db id：You can get it based on the `_id` field returned by https://openapi.akool.com/api/open/audio/create or https://openapi.akool.com/api/open/v3/audio/clone api. |
