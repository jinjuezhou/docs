...
```bash cURL
curl -X POST --location "https://open.akool.com/api/open/v3/faceswap/highquality/specifyimage" \
...
Request request = new Request.Builder()
  .url("https://open.akool.com/api/open/v3/faceswap/highquality/specifyimage")
  .method("POST", body)
...
fetch("https://open.akool.com/api/open/v3/faceswap/highquality/specifyimage", requestOptions)
...
$request = new Request('POST', 'https://open.akool.com/api/open/v3/faceswap/highquality/specifyimage', $headers, $body);
...
RequestBody body = RequestBody.create(mediaType, "{\n    \"sourceImage\": [    \n        {\n            \"path\": \"https://d21ksh0k4smeql.cloudfront.net/crop_1705475757658-3362-0-1705475757797-3713.png\",   \n            \"opts\": \"239,364:386,366:317,472:266,539\"   \n        }\n    ],\n    \"targetImage\": [    \n        {\n            \"path\": \"https://d21ksh0k4smeql.cloudfront.net/crop_1705479323786-0321-0-1705479323896-7695.png\",   \n            \"opts\": \"176,259:243,259:209,303:183,328\" \n        }\n    ],\n    \"modifyVideo\": \"https://d21ksh0k4smeql.cloudfront.net/avatar_01-1705479314627-0092.mp4\",    \n    \"webhookUrl\":\"http://localhost:3007/api/webhook2\" \n\n}");
Request request = new Request.Builder()
  .url("http://open.akool.com/api/v3/faceswap/highquality/specifyvideo")
  .method("POST", body)
  .addHeader("Authorization", "Bearer token")
  .addHeader("Content-Type", "application/json")
  .build();
...
fetch("http://open.akool.com/api/v3/faceswap/highquality/specifyvideo", requestOptions)
  .then((response) => response.text())
  .then((result) => console.log(result))
  .catch((error) => console.error(error));
```
...
$request = new Request('POST', 'http://open.akool.com/api/v3/faceswap/highquality/specifyvideo', $headers, $body);
$res = $client->sendAsync($request)->wait();
echo $res->getBody();
```
...
RequestBody body = RequestBody.create(mediaType, "");
Request request = new Request.Builder()
  .url("https://faceswap.akool.com/api/v2/faceswap/quota/info")
  .method("GET", body)
  .addHeader("Authorization", "Bearer token")
  .build();
Response response = client.newCall(request).execute();
...
fetch("https://faceswap.akool.com/api/v2/faceswap/quota/info", requestOptions)
  .then((response) => response.text())
  .then((result) => console.log(result))
  .catch((error) => console.error(error));
```
...
$request = new Request('GET', 'https://faceswap.akool.com/api/v2/faceswap/quota/info', $headers);
$res = $client->sendAsync($request)->wait();
echo $res->getBody();
```
...
RequestBody body = RequestBody.create(mediaType, "{\n    \"_ids\":\"\"\n}");
Request request = new Request.Builder()
  .url("https://open.akool.com/api/open/v3/faceswap//result/delbyids")
  .method("POST", body)
  .addHeader("Authorization", "Bearer token")
  .addHeader("Content-Type", "application/json")
  .build();
...
fetch("https://open.akool.com/api/open/v3/faceswap//result/delbyids", requestOptions)
  .then((response) => response.text())
  .then((result) => console.log(result))
  .catch((error) => console.error(error));
```
...
$request = new Request('POST', 'https://open.akool.com/api/open/v3/faceswap//result/delbyids', $headers, $body);
$res = $client->sendAsync($request)->wait();
echo $res->getBody();
```
