...
Request request = new Request.Builder()
  .url("http://open.akool.com/api/v3/faceswap/highquality/specifyimage")
  .method("POST", body)
...
fetch("http://open.akool.com/api/v3/faceswap/highquality/specifyimage", requestOptions)
...
$request = new Request('POST', 'http://open.akool.com/api/v3/faceswap/highquality/specifyimage', $headers, $body);
