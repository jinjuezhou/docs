...
|---------------|----------|------------|------------------------------------------------------------------------------|
| video_url     | String   |            | The video url address you want to libsync.                                 |
| audio_url     | String   |            | resource address of the  audio.                                     |
...
Request request = new Request.Builder()
  .url("https://openapitest.akool.com/api/open/v3/content/video/lipsync")
  .method("POST", body)
...
fetch("https://openapitest.akool.com/api/open/v3/content/video/lipsync", requestOptions)
...
$request = new Request('POST', 'https://openapitest.akool.com/api/open/v3/content/video/lipsync', $headers, $body);
