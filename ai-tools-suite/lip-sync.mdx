...
|---------------|----------|------------|------------------------------------------------------------------------------|
| video_url     | String   |            | The video url address you want to lipsync.                                 |
...
fetch("https://openapi.akool.com/api/open/v3/content/video/lipsync", requestOptions)
...
| **Parameter**  | **Type** | **Value** | **Description**                                                                                                                       |
|----------------|----------|-----------|---------------------------------------------------------------------------------------------------------------------------------------|
| video_model_id | String   | NULL      | video db id: You can get it based on the `_id` field returned by https://openapi.akool.com/api/open/v3/content/video/lipsync . |
...
fetch("http://openapi.akool.com/api/open/v3/content/video/infobymodelid?video_model_id=66160f989dfc997ac289037b", requestOptions)
  .then((response) => response.text())
  .then((result) => console.log(result))
  .catch((error) => console.error(error));
```
