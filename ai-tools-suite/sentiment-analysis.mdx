...
| data          | Object   | `{ video_status:1, _id:"", result:"" }` | video_status: the status of video：【1:queueing, 2:processing, 3:completed, 4:failed】 result:  sentiment analysis result【"POSITIVE", "NEGATIVE"】 _id: Interface returns data |
