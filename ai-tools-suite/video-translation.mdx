...
```bash cURL
curl --location 'https://open.akool.com/api/open/v3/content/video/createbytranslate' \
...
Request request = new Request.Builder()
  .url("https://open.akool.com/api/open/v3/content/video/createbytranslate")
  .method("POST", body)
...
fetch("https://open.akool.com/api/open/v3/content/video/createbytranslate", requestOptions)
...
$request = new Request('POST', 'https://open.akool.com/api/open/v3/content/video/createbytranslate', $headers, $body);
...
fetch("http://open.akool.com/api/v3/content/video/infobymodelid?video_model_id=64b126c4a680e8edea44f02b", requestOptions)
  .then((response) => response.text())
  .then((result) => console.log(result))
  .catch((error) => console.error(error));
```
