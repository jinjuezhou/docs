...
fetch("https://openapi.akool.com/api/open/v3/content/video/createbytranslate", requestOptions)
...
| **Parameter**  | **Type** | **Value** | **Description**                                                                                                                       |
|----------------|----------|-----------|---------------------------------------------------------------------------------------------------------------------------------------|
| video_model_id | String   | NULL      | video db id: You can get it based on the `_id` field returned by https://openapi.akool.com/api/open/v3/content/video/createbytranslate . |
...
```bash cURL
curl --location 'http://openapi.akool.com/api/v3/content/video/infobymodelid?video_model_id=64b126c4a680e8edea44f02b' \
--header 'Authorization: Bearer token'
```
...
RequestBody body = RequestBody.create(mediaType, "");
Request request = new Request.Builder()
  .url("http://openapi.akool.com/api/v3/content/video/infobymodelid?video_model_id=64b126c4a680e8edea44f02b")
  .method("GET", body)
  .addHeader("Authorization", "Bearer token")
  .build();
Response response = client.newCall(request).execute();
...
fetch("http://openapi.akool.com/api/v3/content/video/infobymodelid?video_model_id=64b126c4a680e8edea44f02b", requestOptions)
  .then((response) => response.text())
  .then((result) => console.log(result))
  .catch((error) => console.error(error));
```
...
$request = new Request('GET', 'http://openapi.akool.com/api/v3/content/video/infobymodelid?video_model_id=64b126c4a680e8edea44f02b', $headers);
$res = $client->sendAsync($request)->wait();
echo $res->getBody();
```
