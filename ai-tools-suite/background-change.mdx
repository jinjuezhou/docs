...
<Note>In addition to using the required parameters, you must also use one of the two parameters color_code or template_url. Once you use template_url, you must carry three additional parameters: modify_template_size, overlay_template_x, and overlay_template_y.</Note>
...
**Body**
<Note>You have 2 combination parameters to choose from</Note>
<Note>The first combination of parameters:</Note>
```json
{
