...
<Note>In addition to using the required parameters, you can also use one of the two parameters color_code or template_url(but this is not required). Once you use template_url, you must carry three additional parameters: modify_template_size, overlay_template_x, and overlay_template_y.</Note>
...
**Body**
<Note>You have 3 combination parameters to choose from</Note>
<Tip>The first combination of parameters:</Tip>
```json
{
...
```
<Tip>The second combination of parameters:</Tip>
```json
{
"color_code": "#aafbe3",
"canvas_size": "3840x2160",
"origin_img": "https://drz0f01yeq1cx.cloudfront.net/1712128532755-3fd30fa3-8629-408e-b7b5-126eb983e4c2-1781.png",
"modify_origin_img_size": "2143x2146",
"overlay_origin_x": 848,
"overlay_origin_y": 7
}
```

<Tip>The third combination of parameters:</Tip>
```json
{
"canvas_size": "3840x3840",
