...
Request request = new Request.Builder()
  .url("https://open.akool.com/api/open/v3/voice/list")
  .method("GET", body)
...
fetch("https://open.akool.com/api/open/v3/voice/list", requestOptions)
...
$request = new Request('GET', 'https://open.akool.com/api/open/v3/voice/list', $headers);
...
```bash cURL
curl --location 'https://open.akool.com/api/open/v3/content/video/createaudio' \
...
RequestBody body = RequestBody.create(mediaType, "{\r\n    \"input_text\": \"Choose from male and female voices for various use-cases. For tailored options, refer to voice settings or read further.There are both male and female voices to choose from\",\r\n    \"voice_id\": \"LcfcDJNUP1GQjkzn1xUU\",\r\n    \"rate\": \"100%\"\r\n}");
Request request = new Request.Builder()
  .url("https://open.akool.com/api/open/v3/content/video/createaudio")
  .method("POST", body)
...
fetch("https://open.akool.com/api/open/v3/content/video/createaudio", requestOptions)
  .then((response) => response.text())
  .then((result) => console.log(result))
  .catch((error) => console.error(error));
```
...
$request = new Request('POST', 'https://open.akool.com/api/open/v3/content/video/createaudio', $headers, $body);
$res = $client->sendAsync($request)->wait();
echo $res->getBody();
...
```bash cURL
curl --location 'https://open.akool.com/api/open/v3/content/video/audio/infobymodelid?audio_model_id=65f8017f56559aa67f0ecde7' \
--header 'Authorization: Bearer token'
```
...
RequestBody body = RequestBody.create(mediaType, "");
Request request = new Request.Builder()
  .url("https://open.akool.com/api/open/v3/content/video/audio/infobymodelid?audio_model_id=65f8017f56559aa67f0ecde7")
  .method("GET", body)
  .addHeader("Authorization", "Bearer token")
  .build();
Response response = client.newCall(request).execute();
...
fetch("https://open.akool.com/api/open/v3/content/video/audio/infobymodelid?audio_model_id=65f8017f56559aa67f0ecde7", requestOptions)
  .then((response) => response.text())
  .then((result) => console.log(result))
  .catch((error) => console.error(error));
```
...
$request = new Request('GET', 'https://open.akool.com/api/open/v3/content/video/audio/infobymodelid?audio_model_id=65f8017f56559aa67f0ecde7', $headers);
$res = $client->sendAsync($request)->wait();
echo $res->getBody();
```
...
RequestBody body = RequestBody.create(mediaType, "{\r\n    \"talking_photo_url\":\"https://drz0f01yeq1cx.cloudfront.net/1688098804494-e7ca71c3-4266-4ee4-bcbb-ddd1ea490e75-9907.jpg\",\r\n    \"audio_url\":\"https://drz0f01yeq1cx.cloudfront.net/1710752141387-e7867802-0a92-41d4-b899-9bfb23144929-4946.mp3\"\r\n}");
Request request = new Request.Builder()
  .url("https://open.akool.com/api/open/v3/content/video/createbytalkingphoto")
  .method("POST", body)
  .addHeader("Authorization", "Bearer token")
  .addHeader("Content-Type", "application/json")
  .build();
...
fetch("https://open.akool.com/api/open/v3/content/video/createbytalkingphoto", requestOptions)
  .then((response) => response.text())
  .then((result) => console.log(result))
  .catch((error) => console.error(error));
```
...
$request = new Request('POST', 'https://open.akool.com/api/open/v3/content/video/createbytalkingphoto', $headers, $body);
$res = $client->sendAsync($request)->wait();
echo $res->getBody();
```
...
RequestBody body = RequestBody.create(mediaType, "");
Request request = new Request.Builder()
  .url("https://open.akool.com/api/open/v3/content/video/infobymodelid?video_model_id=64dd838cf0b6684651e90217")
  .method("GET", body)
  .addHeader("Authorization", "Bearer token")
  .build();
Response response = client.newCall(request).execute();
...
fetch("https://open.akool.com/api/open/v3/content/video/infobymodelid?video_model_id=64dd838cf0b6684651e90217", requestOptions)
  .then((response) => response.text())
  .then((result) => console.log(result))
  .catch((error) => console.error(error));
```
...
$request = new Request('GET', 'https://open.akool.com/api/open/v3/content/video/infobymodelid?video_model_id=64dd838cf0b6684651e90217', $headers);
$res = $client->sendAsync($request)->wait();
echo $res->getBody();
```
