...
Request request = new Request.Builder()
  .url("https://openapi.akool.com/api/open/v3/voice/list")
  .method("GET", body)
...
fetch("https://openapi.akool.com/api/open/v3/voice/list", requestOptions)
...
$request = new Request('GET', 'https://openapi.akool.com/api/open/v3/voice/list', $headers);
...
```
POST https://openapi.akool.com/api/open/v3/content/video/createaudio
```
...
| voice_id      | String   |           | Voice id: get from [https://openapi.akool.com/api/open/v3/voice/list](https://openapi.akool.com/api/open/v3/voice/list) api，the field is 【voice_id】 |
...
```bash cURL
curl --location 'https://openapi.akool.com/api/open/v3/content/video/createaudio' \
...
fetch("https://openapi.akool.com/api/open/v3/content/video/createaudio", requestOptions)
  .then((response) => response.text())
  .then((result) => console.log(result))
  .catch((error) => console.error(error));
```
...
$request = new Request('POST', 'https://openapi.akool.com/api/open/v3/content/video/createaudio', $headers, $body);
$res = $client->sendAsync($request)->wait();
echo $res->getBody();
...
```
GET https://openapi.akool.com/api/open/v3/content/video/audio/infobymodelid?audio_model_id=65f8017f56559aa67f0ecde7
```
...
| **Parameter**  | **Type** | **Value** | **Description**                                                                                                                   |
|----------------|----------|-----------|-----------------------------------------------------------------------------------------------------------------------------------|
| audio_model_id | String   |           | audio db id：You can get it based on the `_id` field returned by https://openapi.akool.com/api/open/v3/content/video/createaudio api. |
...
```bash cURL
curl --location 'https://openapi.akool.com/api/open/v3/content/video/audio/infobymodelid?audio_model_id=65f8017f56559aa67f0ecde7' \
--header 'Authorization: Bearer token'
```
...
RequestBody body = RequestBody.create(mediaType, "");
Request request = new Request.Builder()
  .url("https://openapi.akool.com/api/open/v3/content/video/audio/infobymodelid?audio_model_id=65f8017f56559aa67f0ecde7")
  .method("GET", body)
  .addHeader("Authorization", "Bearer token")
  .build();
Response response = client.newCall(request).execute();
...
fetch("https://openapi.akool.com/api/open/v3/content/video/audio/infobymodelid?audio_model_id=65f8017f56559aa67f0ecde7", requestOptions)
  .then((response) => response.text())
  .then((result) => console.log(result))
  .catch((error) => console.error(error));
```
...
$request = new Request('GET', 'https://openapi.akool.com/api/open/v3/content/video/audio/infobymodelid?audio_model_id=65f8017f56559aa67f0ecde7', $headers);
$res = $client->sendAsync($request)->wait();
echo $res->getBody();
```
...
| **Parameter**  | **Type** | **Value** | **Description**                                                                                                                          |
|----------------|----------|-----------|------------------------------------------------------------------------------------------------------------------------------------------|
| video_model_id | String   |           | video db id：You can get it based on the _id field returned by https://openapi.akool.com/api/open/v3/content/video/createbytalkingphoto api. |
