...
RequestBody body = RequestBody.create(mediaType, "{\n    \"input_text\": \"Choose from male and female voices for various use-cases. For tailored options, refer to voice settings or read further.There are both male and female voices to choose from\",\n    \"voice_id\": \"LcfcDJNUP1GQjkzn1xUU\",\n    \"rate\": \"100%\"\n}");
Request request = new Request.Builder()
  .url("https://contenttest.akool.com/api/open/v3/content/video/createaudio")
  .method("POST", body)
...
fetch("https://contenttest.akool.com/api/open/v3/content/video/createaudio", requestOptions)
  .then((response) => response.text())
  .then((result) => console.log(result))
  .catch((error) => console.error(error));
```
...
$request = new Request('POST', 'https://contenttest.akool.com/api/open/v3/content/video/createaudio', $headers, $body);
$res = $client->sendAsync($request)->wait();
echo $res->getBody();
```
...
RequestBody body = RequestBody.create(mediaType, "");
Request request = new Request.Builder()
  .url("https://contenttest.akool.com/api/open/v3/content/video/audio/infobymodelid?audio_model_id=65f8017f56559aa67f0ecde7")
  .method("GET", body)
  .addHeader("Authorization", "Bearer token")
  .build();
Response response = client.newCall(request).execute();
...
fetch("https://contenttest.akool.com/api/open/v3/content/video/audio/infobymodelid?audio_model_id=65f8017f56559aa67f0ecde7", requestOptions)
  .then((response) => response.text())
  .then((result) => console.log(result))
  .catch((error) => console.error(error));
```
...
$request = new Request('GET', 'https://contenttest.akool.com/api/open/v3/content/video/audio/infobymodelid?audio_model_id=65f8017f56559aa67f0ecde7', $headers);
$res = $client->sendAsync($request)->wait();
echo $res->getBody();
```
